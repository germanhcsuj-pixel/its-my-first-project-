...
const ALL_QUESTIONS = [
  ...
  { icon: 'Как начать программировать с нуля?', text: "Как начать программи��овать с нуля?" },
...
Р С›РЎвЂљР Р†Р ВµРЎвЂЎР В°Р в„– Р Р…Р В° РЎР‚РЎС“РЎРѓРЎРѓР С”Р С•Р С РЎРЏР В·РЎвЂ№Р С”Р Вµ. Р вЂќР В°Р Р†Р В°Р в„– Р СР ВµРЎвЂљР С•Р Т‘Р С‘РЎвЂЎР ВµРЎРѓР С”Р С‘Р Вµ РЎР‚Р ВµР С”Р С•Р СР ВµР Р…Р Т‘Р В°РЎвЂ Р С‘Р С‘, РЎС“Р С—РЎР‚Р В°Р В¶Р Р…Р ВµР Р…Р С‘Р��РЏ Р С‘ РЎРѓР С•Р Р†Р ВµРЎвЂљРЎвЂ№ Р С—Р С• Р С”Р С•РЎР‚РЎР‚Р ВµР С”РЎвЂ Р С‘Р С•Р Р…Р Р…Р С•Р в„– РЎР‚Р В°Р В±Р С•РЎвЂљР Вµ.`;
  }
...
(function () {
  ...
  const packs = {
    ...
    kk: {
      ...
      sessionJournal: 'СабаТ› журналы',
      sessionDesc: 'ТљаТ“аз дУ™птердіТЈ орнына ортаТ› цифрлыТ› база',
      whyTitle: 'Р вЂР СћР’В±Р » Р Р…Р Вµ Р СћР вЂЎР��в‚¬РЎвЂ“Р Р…?',
...
(function() {
    ...
    const generatedData = {
        "ru": [
            ...
            "основы фронтенд разработки","подготовка к школе логопед","упражнения для артику��яции","упражнения для беглой речи",
            ...
            "Р С”Р В°Р С” Р С•РЎР‚Р С–Р В°Р Р…Р С‘Р В·Р С•Р Р†Р В°РЎвЂљРЎРЉ РЎРѓР Р†Р С•Р Вµ Р Р†РЎР‚Р ВµР СРЎРЏ","Р СР ВµРЎвЂљР С•Р Т‘РЎвЂ№ Р В°Р Т‘Р В°Р С—РЎвЂљР С‘Р Р†Р Р…Р С•Р С–Р С• Р С•Р В±РЎС“РЎвЂЎР ВµР Р…Р С‘РЎРЏ","Р СР ВµРЎвЂљ�� С•Р Т‘РЎвЂ№ Р С—РЎР‚Р С•Р В±Р »Р ВµР СР Р…Р С•Р С–Р С• Р С•Р В±РЎС“РЎвЂЎР ВµР Р…Р С‘РЎРЏ","Р С•РЎРѓР Р…Р С•Р Р†РЎвЂ№ Р СР С•Р В±Р С‘Р »РЎРЉР Р…Р С•Р в„– РЎР‚Р В°Р В·РЎР‚Р В°Р В±Р С•РЎвЂљР С”Р С‘",
        ...
        "kz": [
            ...
            "Р В¶Р В°Р В·Р В±Р В° РўвЂєР В°РЎвЂљРЎвЂ№Р Р…Р В°РЎРѓРЎвЂ№Р Р… Р В¶Р В°РўвЂєРЎРѓР В°РЎР‚РЎвЂљРЎС“","Р В¶Р ВµР »РЎвЂ“ РўвЂєР В°Р В±Р В°РЎвЂљРЎвЂ№ Р Т‘Р ВµР С–Р ВµР Р…РЎвЂ“Р СРЎвЂ“Р В· Р Р…Р Вµ","Р В¶РўР‡РЎР‚Р С–РЎвЂ“Р Р…Р Т‘РЎвЂ“Р С” Р С•РўвЂєРЎвЂ№РЎвЂљРЎС“ РЈв„ўР Т‘РЎвЂ“��ЎРѓРЎвЂљР ВµРЎР‚РЎвЂ“","Р С‘Р СР С—РЎР‚Р С•Р Р†Р С‘Р В·Р Вµ РЎвЂ“РЎРѓРЎвЂљР ВµРЎС“Р Т‘РЎвЂ“ РўР‡Р в„–РЎР‚Р ВµР Р…РЎС“",
...
(function() {
    ...
    // Р РЋР С‘Р Р…РЎвЂ¦РЎР‚Р С•Р Р…Р С‘Р В·Р В°РЎвЂ Р С‘РЎР��: Р С”Р С•Р С–Р Т‘Р В° openModal() РЎРѓР В±РЎР‚Р В°РЎРѓРЎвЂ№Р Р†Р В°Р ВµРЎвЂљ checkbox РІвЂ вЂ™ Р В·Р В°Р С”РЎР‚РЎвЂ№Р Р†Р В°Р ВµР С sidebar
...
window.handleWallpaperUpload = function(event, view) {
    ...
    if (file) {
        if (file.type.startsWith('video/')) {
            ...
            alert('Обратите внимание: загруженное видео будет работать только до перез��грузки страницы. Для постоянного видеофона поместите файл рядом с index.html.');
        } else {
            const reader = new FileReader();
            reader.onload = function(e) {
                const dataUrl = e.target.result;
