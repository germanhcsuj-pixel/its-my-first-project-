...
export const metadata: Metadata = {
	title: "Terms of Service - Solifon Studio",
	description:
		"Solifon Studio's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - Solifon Studio",
		description:
			"Solifon Studio's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>Don't use Solifon Studio for illegal activities or harassment</li>
							<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					<strong>You own everything you create.</strong> Solifon Studio processes basic
					...
					or any content you create using Solifon Studio.
				</p>
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from Solifon Studio</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use Solifon Studio</h2>
				<p>Solifon Studio is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use Solifon Studio for client work and paid projects</li>
					<li>Share and distribute videos created with Solifon Studio</li>
					<li>Modify and distribute the Solifon Studio software (under MIT license)</li>
				</ul>
				<p>
					<strong>What we ask:</strong> Don't use Solifon Studio for illegal activities,
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Solifon Studio offers optional AI-powered features that require server
					processing:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Solifon Studio is provided "as is" without warranties. While we strive for
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because Solifon Studio is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host Solifon Studio on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					When using Solifon Studio, make sure you have the right to use any content you
					import:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>Solifon Studio is provided free of charge. To the extent permitted by law:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update Solifon Studio and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using Solifon Studio at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Delete your account through your profile settings</li>
					<li>Clear your browser data to remove local projects</li>
					<li>Your content remains yours even if you stop using Solifon Studio</li>
