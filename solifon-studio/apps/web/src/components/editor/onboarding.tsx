...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return t('Welcome to Solifon Studio Beta! 🎉');
			case 1:
				return t('⚠️ This is a super early beta!');
			case 2:
				return t('🦋 Have fun testing!');
			default:
				return t('Solifon Studio Onboarding');
		}
	};
			...
			case 0:
				return (
					<div className="space-y-5">
						...
						<Title title={t('Welcome to Solifon Studio Beta! 🎉')} />
						<Description description={t("You're among the first to try Solifon Studio - the fully open source CapCut alternative.")} />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={t('Join our [Discord]({{url}}), chat with cool people and share feedback to help make Solifon Studio the best editor ever.', { url: SOCIAL_LINKS.discord })}
							/>
						</div>
