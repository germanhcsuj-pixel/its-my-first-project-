...
export async function HomepageJsonLd({ locale }: { locale: string }) {
	...
	const webApplicationSchema = {
		...
		url: SITE_URL,
		description: t(
			"Solifon Studio is an AI-native, open-source video editor that runs entirely in your browser. A free, privacy-first alternative to CapCut with AI-powered editing, multi-track timeline, and MP4/WebM export — no uploads, no tracking.",
		),
